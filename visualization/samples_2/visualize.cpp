...
void test2() {
    ...
    std::string relays_mst_graph_Lam_SEF_path = DATA_DIR + "relays_mst_graph_Lam_SEF.txt";
    ...
    std::string relays_mst_graph_Lam_SEF_img_path = DATA_DIR + "relays_mst_graph_Lam_SEF.png";
    ...
    /* draw relays mst graph Lam_SEF */
    Graph relays_mst_graph_Lam_SEF = Graph::load(relays_mst_graph_Lam_SEF_path);
    relays_mst_graph_Lam_SEF.draw_targets(targets);
    relays_mst_graph_Lam_SEF.draw(relays_mst_graph_Lam_SEF_img_path);
}
