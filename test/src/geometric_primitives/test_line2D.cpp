...
TEST(TestLine2D, TestLine2D_1)
{
    ...
    std::cout << line2D << '\n';
    Line2D line2D_1 = Line2D::fromCoefficients(std::vector<long double>{2, 1, -3});
    std::cout << line2D_1 << '\n';
...
TEST(TestLine2D, TestLine2D_2)
{
    ...
    Line2D line2D = Line2D(point0, norm_vector);
    std::cout << line2D << '\n';
    Line2D line2D_1 = Line2D::fromCoefficients(std::vector<long double>{0, 1, -1});
    std::cout << line2D_1 << '\n';
...
TEST(TestLine2D, TestLine2D_findIntersection)
{
    ...
    Line2D line2D_3 = Line2D::fromCoefficients(std::vector<long double>{1, 1, -2});
    Line2D line2D_4 = Line2D::fromCoefficients(std::vector<long double>{2, 1, -3});
    Point2D p3(1, 1);
