...
TEST(TestQuadraticEquation, TestQuadraticEquation_1)
{
    ...
    std::pair<long double, long double> solutions = quadratic_equation.solve();
    ASSERT_long double_EQ(solutions.first, 1.0);
    ASSERT_long double_EQ(solutions.second, 1.0);
}
...
TEST(TestQuadraticEquation, TestQuadraticEquation_3)
{
    ...
    std::pair<long double, long double> solutions = quadratic_equation.solve();
    ASSERT_long double_EQ(solutions.first, -2.0);
    ASSERT_long double_EQ(solutions.second, 1.0);
}
