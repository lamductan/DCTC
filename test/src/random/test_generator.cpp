...
{
    DoubleGenerator long double_generator_1(0, 1000);
    sleep(1);
    DoubleGenerator long double_generator_2(0, 1000);

    for(int i = 0; i < 10; ++i) std::cout << long double_generator_1.next() << ' ';
    std::cout << '\n';

    for(int i = 0; i < 10; ++i) std::cout << long double_generator_2.next() << ' ';
    std::cout << '\n';
}

TEST(TestGenerator, TestDoubleGenerator_2)
{
    DoubleGenerator long double_generator_1(0, 1000, true);
    sleep(1);
    DoubleGenerator long double_generator_2(0, 1000, true);
